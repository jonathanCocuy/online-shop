...
export default function RegisterForm() {
    ...
    return (
        <div className="flex items-start
         justify-center w-full h-full p-4 md:p-8 lg:p-12 min-h-screen">
            {/* Container of the form */}
            <div className={`${authLayoutWrapperClasses} bg-gray-500 rounded-4xl bg-[url('/images/register.webp')] bg-cover bg-center bg-no-repeat flex items-center justify-end h-[620px]`}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 px-2 md:px-4 lg:px-4" suppressHydrationWarning>
                        ...
                        <div className="flex items-center justify-between gap-2">
                            <Button
                                ...
                                size="md"
                                disabled={isLoading}
                                className="w-[80%] bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold shadow-lg h-10"
                            >
                                {isLoading ? (
