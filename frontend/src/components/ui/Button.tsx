...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
    variant?: 'primary' | 'secondary' | 'success' | 'danger' | 'warning' | 'info' | 'ghost' | 'pink' | 'google';
    size?: 'sm' | 'md' | 'lg';
...
export const Button: React.FC<ButtonProps> = ({ 
    ...
    const variantStyles = {
        ...
        pink: 'bg-pink-400 hover:bg-pink-600 text-white focus:ring-pink-400',
        google: 'bg-white hover:bg-gray-100 text-gray-900 focus:ring-gray-500 border border-gray-300',
    };
