...
export default function CartCard({
    ...
    const quantityControls = (
        <div className="flex items-center bg-gray-900 rounded-lg border border-gray-700">
            ...
            <span className="px-4 py-2 text-white font-semibold min-w-[3rem] text-center text-xs md:text-base">
                {item.quantity}
            </span>
            <button
                onClick={onIncrement}
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 hover:border-blue-500/50 transition-all duration-300">
            ...
            <div className="flex flex-col gap-4 md:hidden">
                ...
                <div className="flex gap-4 items-start">
                    <div className="relative w-20 h-20 bg-gray-700 rounded-xl overflow-hidden flex-shrink-0">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="text-md font-bold text-white mt-1">
                            {currencySymbol} {formatPrice(item.price, item.currency)}
                        </div>
                    </div>
                </div>

                {/* Row 2: Quantity label + controls + delete */}
                ...
                <div className="pt-4 border-t border-gray-700 flex justify-between items-center">
                    ...
                    <span className="text-xl font-bold text-green-400">
                        {currencySymbol} {formatPrice(item.price * item.quantity, item.currency)}
                    </span>
                </div>
            </div>
            ...
            <div className="hidden md:flex md:flex-row gap-6">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex md:items-center md:justify-between gap-4 mt-2">
